		...
		if(mysql_num_rows($info_result))
		{
			...
			$results_query = "select 
								...
								(case 
									...
									when  (c.ccode not like 'AEC%' and c.ccode not like 'AOC%' and c.ccode not like 'FRE%' and c.ccode not like 'SEC%' and r.tp like 'T') and r.ie1 >= 10 then 'P'
									else 'F' end) as internal_pass,
								(case 
									when  (c.ccode like 'AEC%' or c.ccode like 'AOC%' or c.ccode like 'FRE%' or c.ccode like 'SEC%' or r.tp like 'P' or r.tp like 'PW') and r.se1 >= 16 then 'P'
									when  (c.ccode not like 'AEC%' and c.ccode not like 'AOC%' and c.ccode not like 'FRE%' and c.ccode not like 'SEC%' and r.tp like 'T') and r.se1 >= 30 then 'P'
									else 'F' end) as external_pass,
								(case 
									when  (c.ccode like 'AEC%' or c.ccode like 'AOC%' or c.ccode like 'FRE%' or c.ccode like 'SEC%' or r.tp like 'P' or r.tp like 'PW') and r.ie1 >= 4 and r.se1 >= 16 then 'P'
									when  (c.ccode not like 'AEC%' and c.ccode not like 'AOC%' and c.ccode not like 'FRE%' and c.ccode not like 'SEC%' and r.tp like 'T') and r.ie1 >= 10 and r.se1 >= 30 then 'P'
									else 'F' end) as pass,
